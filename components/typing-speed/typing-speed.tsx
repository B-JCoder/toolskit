...
const TypingSpeedComponent = () => {
  ...
  const displayValues = useMemo(
    () => ({
      ...
      statusText:
        !hasStarted ? 'Click start and begin typing' : isActive ? 'Keep typing!' : timeLeft === 0 ? 'Test completed!' : 'Test paused',
    }),
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                <div className="p-4 rounded-lg bg-primary/10">
                  ...
                  <div className="text-3xl font-bold text-primary text-center">{displayValues.timeDisplay}</div>
                ...
                <div className="p-4 rounded-lg bg-primary/10">
                  ...
                  <div className="text-3xl font-bold text-primary text-center">{wpm}</div>
                  <div className="text-xs text-muted-foreground text-center mt-1">words/min</div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-primary/10">
                  ...
                  <div className="text-3xl font-bold text-primary text-center">{accuracy}%</div>
                  <div className="text-xs text-muted-foreground text-center mt-1">correct</div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-primary/10">
                  ...
                  <div className="text-3xl font-bold text-primary text-center">{totalChars}</div>
                  <div className="text-xs text-muted-foreground text-center mt-1">characters</div>
                </div>
              </div>
              ...
              {hasStarted && timeLeft === 0 && (
                <div className="p-6 bg-gradient-to-br from-green-50 to-green-50/50 dark:from-green-950/20 dark:to-green-950/10 rounded-xl border border-green-200 dark:border-green-800">
                  <h3 className="text-2xl font-bold mb-6 text-center">Test Completed! 🎉</h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                    <div className="text-center p-4 bg-white dark:bg-black/20 rounded-lg">
                      <div className="font-semibold text-muted-foreground mb-2">Final WPM</div>
                      <div className="text-3xl font-bold text-primary">{wpm}</div>
                    </div>
                    <div className="text-center p-4 bg-white dark:bg-black/20 rounded-lg">
                      <div className="font-semibold text-muted-foreground mb-2">Accuracy</div>
                      <div className="text-3xl font-bold text-primary">{accuracy}%</div>
                    </div>
                    <div className="text-center p-4 bg-white dark:bg-black/20 rounded-lg col-span-2 md:col-span-1">
                      <div className="font-semibold text-muted-foreground mb-2">Characters</div>
