  ...
  return (
    <>
      <StructuredData
        ...
        url="https://toolfixo.online/gpa-calculator"
        applicationCategory="EducationalApplication"
      />

      <div className="container mx-auto px-4 py-8">
        <Breadcrumbs
          items={[{ label: "GPA Calculator", href: "/gpa-calculator" }]}
        />
          ...
          <div className="mt-16 space-y-8 prose prose-gray dark:prose-invert max-w-none">
            <div className="bg-muted/50 rounded-lg p-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                academic performance. It's calculated by averaging the grade
                points earned in all courses, weighted by credit hours. GPA is
                commonly used by schools, colleges, and employers to assess
                academic achievement and competency.
              </p>
            </div>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                <li>
                  Enter your course name (optional but helpful for organization)
                </li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex gap-3">
                  ...
                  <span>
                    Credit hours are weighted automatically in the calculation
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                ...
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>
                    Transfer credits or AP courses may be calculated differently
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>
                    Always verify your GPA with your academic institution
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Use this calculator to track your GPA throughout the semester
                and set academic goals. Monitor your progress and adjust your
                study habits as needed to achieve your target GPA. Remember that
                consistency and effort are key to academic success.
              </p>
            </div>
          </div>
        </ToolPageLayout>
