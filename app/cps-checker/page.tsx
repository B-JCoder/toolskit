          ...
          <div className="mt-16 space-y-8 prose prose-gray dark:prose-invert max-w-none">
            <div className="bg-muted/50 rounded-lg p-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                popular way to test your clicking speed, reaction time, and mouse control skills. This metric is
                important for gamers, professionals, and anyone looking to improve their mouse efficiency.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 border-l-4 border-gray-500 bg-gray-50 dark:bg-gray-950/20 rounded">
                  ...
                  <p className="text-sm text-muted-foreground">1-3 CPS - Beginner level</p>
                </div>
                <div className="p-4 border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-950/20 rounded">
                  <p className="font-semibold">Average</p>
                  <p className="text-sm text-muted-foreground">4-7 CPS - Normal clicking speed</p>
                </div>
                <div className="p-4 border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-950/20 rounded">
                  ...
                  <p className="text-sm text-muted-foreground">8-10 CPS - Above average</p>
                </div>
                <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-950/20 rounded">
                  ...
                  <p className="text-sm text-muted-foreground">11+ CPS - Professional level</p>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-xl font-semibold mb-4">How to Use the CPS Checker:</h3>
              <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                <li>Select your preferred test duration (5, 10, or 30 seconds)</li>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4">Tips to Improve Your CPS:</h3>
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>Use your index or middle finger for consistent clicking</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>Keep your hand relaxed to avoid fatigue and cramping</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                ...
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>Try different clicking techniques like jitter clicking or butterfly clicking</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>Ensure your mouse is responsive and properly calibrated</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Consistency matters more than speed. Focus on maintaining a steady click rate rather than sporadically
                clicking as hard as possible. Regular practice will naturally improve both your speed and endurance.
              </p>
            </div>
          </div>
        </ToolPageLayout>
