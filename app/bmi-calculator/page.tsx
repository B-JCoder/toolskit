          ...
          <div className="mt-16 space-y-8 prose prose-gray dark:prose-invert max-w-none">
            <div className="bg-muted/50 rounded-lg p-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                It provides a quick assessment of whether you are underweight, normal weight, overweight, or obese. BMI is
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-950/20 rounded">
                  <p className="font-semibold text-blue-900 dark:text-blue-200">Underweight</p>
                ...
                <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-950/20 rounded">
                  <p className="font-semibold text-green-900 dark:text-green-200">Normal weight</p>
                ...
                <div className="p-4 border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-950/20 rounded">
                  <p className="font-semibold text-yellow-900 dark:text-yellow-200">Overweight</p>
                ...
                <div className="p-4 border-l-4 border-red-500 bg-red-50 dark:bg-red-950/20 rounded">
                  <p className="font-semibold text-red-900 dark:text-red-200">Obese</p>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4">How to Use This Calculator:</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4">Important Health Information:</h3>
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>BMI is a screening tool only and does not directly measure body fat or overall health</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>
                    Athletes and muscular individuals may have a higher BMI without excess body fat
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>Age, gender, ethnicity, and muscle mass can affect BMI interpretation</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary font-bold">•</span>
                  <span>Always consult with healthcare professionals for personalized health advice</span>
                </li>
              </ul>
            </div>

            <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-3 text-blue-900 dark:text-blue-200">⚕️ Disclaimer</h3>
              <p className="text-sm text-muted-foreground">
                This BMI calculator is for informational purposes only and should not be considered medical advice. Your
                BMI is just one indicator of health. For comprehensive health assessment and personalized recommendations,
                please consult with a qualified healthcare professional or doctor.
              </p>
            </div>
          </div>
        </ToolPageLayout>
